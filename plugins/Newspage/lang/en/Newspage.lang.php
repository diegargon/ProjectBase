...
$LANGDATA['L_NEWS_MEDIA'] = "News main photo or video";
...
$LANGDATA['L_NEWS_LEAD_MINMAX_ERROR'] = "The lad must have between ". $config['NEWS_LEAD_MAX_LENGHT'] ." and ". $config['NEWS_LEAD_MIN_LENGHT'] ." characteres";
...
$LANGDATA['L_NEWS_MAIN_MEDIA'] = "Main omage or video";
$LANGDATA['L_NEWS_MEDIALINK_ERROR'] = "Imagen not valid";
...
$LANGDATA['L_NEWS_MODIFY'] = "Modifyr";
...
$LANGDATA['L_NEWS_INFRONTPAGE'] = "In Frontopage";
