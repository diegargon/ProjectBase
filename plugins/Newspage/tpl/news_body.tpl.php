...
<div id="news_container" class="newsrow">
    <div  class="clear bodysize page">
        ...
        <section class="article_body">
            ...
            <div>                
                <a href="https://www.facebook.com/dialog/share?app_id=1481492868545684&display=popup&href=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>&redirect_uri=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>" target="_blank"><img width="19" height="19" src="https://static.xx.fbcdn.net/rsrc.php/v3/y1/r/Y3dI7TtNnYf.png" alt="facebook" /></a>
                <a href="https://meneame.net/submit.php?url=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>" target="_blank"><img width="19" height="19" src="http://communityanalisis.com/wp-content/uploads/2014/06/meneame.png" alt="Meneame" /></a>
                <a href="https://twitter.com/share?url=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>&text=<?php print $data['title']?>" target="_blank"><img width="19" height="19" src="https://www.siamcomm.com/wp-content/uploads/2011/05/twitter.png" alt="Tweeter" /></a>
                <a href="https://plus.google.com/share?url=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>" target="_blank"><img width="19" height="19" src="https://widgets.digitalmediacommunications.com/images/html5/shareicon_googleplus.png" alt="Google+" /></a>
                <a href="https://www.reddit.com/submit?url=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>&title=<?php print $data['title']?>" target="_blank"><img width="19" height="19" src="https://cdn4.iconfinder.com/data/icons/social-messaging-ui-color-shapes-2-free/128/social-reddit-square2-128.png" alt="Reddit" /></a>
            </div>
