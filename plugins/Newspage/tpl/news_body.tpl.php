    ...
    <div  class="clear bodysize page">
        ...
        <section class="article_body">
            ...
            <div>                
                ...
                <a rel="nofollow" href="https://meneame.net/submit.php?url=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>" target="_blank"><img width="19" height="19" src="http://communityanalisis.com/wp-content/uploads/2014/06/meneame.png" alt="Meneame" /></a>
                <a rel="nofollow" href="https://twitter.com/share?url=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>&text=<?php print $data['title']?>" target="_blank"><img width="19" height="19" src="https://www.siamcomm.com/wp-content/uploads/2011/05/twitter.png" alt="Tweeter" /></a>
                <a rel="nofollow" href="https://plus.google.com/share?url=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>" target="_blank"><img width="19" height="19" src="https://widgets.digitalmediacommunications.com/images/html5/shareicon_googleplus.png" alt="Google+" /></a>
                <a rel="nofollow" href="https://www.reddit.com/submit?url=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>&title=<?php print $data['title']?>" target="_blank"><img width="19" height="19" src="https://cdn4.iconfinder.com/data/icons/social-messaging-ui-color-shapes-2-free/128/social-reddit-square2-128.png" alt="Reddit" /></a>
            </div>
