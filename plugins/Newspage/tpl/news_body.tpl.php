    ...
    <div  class="clear bodysize page">
        ...
        <section class="article_body">
            ...
            <div>                
                ...
                <a rel="nofollow" href="https://twitter.com/share?url=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>&text=<?php print $data['title']?>" target="_blank"><img width="19" height="19" src="<?php echo $config['STATIC_SRV_URL'] . '/plugins/Newspage/tpl/images/Twitter.png' ?>" alt="Tweeter" /></a>
                ...
                <a rel="nofollow" href="https://www.reddit.com/submit?url=<?php print "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>&title=<?php print $data['title']?>" target="_blank"><img width="19" height="19" src="<?php echo $config['STATIC_SRV_URL'] . '/plugins/Newspage/tpl/images/Reddit.png' ?>" alt="Reddit" /></a>
            </div>
