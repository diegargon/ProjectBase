    ...
    <div class="standard_box submit_box">        
        ...
        <div class="submit_items">
            <p> 
                ...
                <input value="<?php isset($data['main_media']) ? print $data['main_media'] : false ?>"  minlength="<?php print $config['NEWS_MEDIA_MIN_LENGHT']?>" maxlength="<?php print $config['NEWS_MEDIA_MAX_LENGHT']?>" class="news_link" name="news_main_media" type="text" placeholder="http://site.com/image.jpg"/>
            </p>
        </div> 
<?php
if ($config['NEWS_SOURCE']) { ?>
        <div class="submit_items">
            <p> 
                <label for="news_main_media"><?php print $LANGDATA['L_NEWS_SOURCE'] ?> </label>
                <input value="<?php isset($data['news_source']) ? print $data['news_source'] : false ?>"  minlength="<?php print $config['NEWS_MEDIA_MIN_LENGHT']?>" maxlength="<?php print $config['NEWS_MEDIA_MAX_LENGHT']?>" class="news_link" name="news_source" type="text" placeholder="http://site.com"/>
            </p>
        </div>             
<?php } ?>            
        <div class="submit_items">
