...
<html dir="<?php print $config['WEB_DIR'] ?>" lang="<?php print $config['WEB_LANG'] ?>">
    <head>
        ...
        ?>
        <link rel="apple-touch-icon" sizes="76x76" href="<?php print $config['WEB_URL'] ?>apple-touch-icon.png" />
        <link rel="icon" type="image/png" href="<?php print $config['WEB_URL'] ?>favicon-32x32.png" sizes="32x32" />
        <link rel="icon" type="image/png" href="<?php print $config['WEB_URL'] ?>favicon-16x16.png" sizes="16x16" />
        <link rel="manifest" href="<?php print $config['WEB_URL'] ?>manifest.json" />
        <link rel="mask-icon" href="<?php print $config['WEB_URL'] ?>safari-pinned-tab.svg" />        
        <link rel="icon" href="<?php print $config['WEB_URL'] ?>favicon.ico" type='image/x-icon' />
        <?php
