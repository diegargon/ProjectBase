...
function SimpleACL_UserRoles($msg) {
    ...
    if (!empty($_POST['btnAddRole']) && !empty($search_user) ) {
        $msg = SimpleACL_AddRole($search_user);        
    }
    if (!empty($_POST['btnDeleteRole']) && !empty($search_user) ) {
        $msg = SimpleACL_DelRole($search_user);        
    }
