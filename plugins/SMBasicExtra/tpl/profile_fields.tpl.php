...
<div id="field_switcher">
    <label for="optional_switcher"><?= $LANGDATA['L_SM_PROFILE_OPTIONAL'] ?></label>
...
<div id="optional_profile_fields">
    <?php if ($config['smb_xtr_realname']) { ?>
        <dl>
            <dt><label><?= $LANGDATA['L_SM_REALNAME'] ?></label></dt>
            <dd>
                <input class="realname" name="realname" type="text"  value="<?= $data['realname'] ?>" title="" autocomplete="off"/>
            </dd>
        </dl>
        <dl>
            <dt><label><?= $LANGDATA['L_SM_REALNAME_PUBLIC'] ?></label></dt>
            <dd>
    ...
    <?php } ?>    
    <dl>
        <dt><label><?= $LANGDATA['L_SM_EMAIL_PUBLIC'] ?></label></dt>
        <dd>
