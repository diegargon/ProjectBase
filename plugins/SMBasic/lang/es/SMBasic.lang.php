...
$LANGDATA['L_USERNAME'] = "Nombre de usuario";
$LANGDATA['L_E_INTERNAL'] = "Error interno";
$LANGDATA['L_E_EMAILPASSWORD'] = "Email o contraseña incorrecta";
$LANGDATA['L_E_EMAIL'] = "Email incorrecto";
$LANGDATA['L_E_USERNAME'] = "Nombre de usuario con caracteres no permitidos o demasiado largo";
$LANGDATA['L_E_PASSWORD'] = "Contraseña con caracteres no permitidos o demasiado largo";
$LANGDATA['L_E_PASSWORD_MIN'] = "Contraseña demasiado corta";
$LANGDATA['L_E_USERNAME_EXISTS'] = "Nombre de usuario ya esta siendo utilizado";
$LANGDATA['L_E_EMAIL_EXISTS'] = "Correo electronico ya esta siendo utilizado";
$LANGDATA['L_REG_ERROR_WHILE_REG'] = "Error durante el registro, por favor intentelo de nuevo";
...
$LANGDATA['L_E_PASSWORD_EMPTY_SHORT'] = "Contaseña demasiado corta";
$LANGDATA['L_E_NEW_BOTH_PASSWORD'] = "Para cambiar la contraseña necesitas rellenar la nueva contraseña y repetirla";
$LANGDATA['L_E_NEWPASS_TOOSHORT'] = "Nueva contraseña demasiado cortas";
$LANGDATA['L_E_NEW_PASSWORD_NOTMATCH'] = "Las campos para cambiar la contraseña nueva no concuerda";
...
$LANGDATA['L_E_EMAIL_NOEXISTS'] = "Email no existe";
...
$LANGDATA['L_E_ALREADY_LOGGED'] = "Ya estas identificado";
$LANGDATA['L_E_NOT_LOGGED'] = "No estas identificado";
$LANGDATA['L_BACKHOME'] = "Volver al inicio";
$LANGDATA['L_ANONYMOUS'] = "Anonimo";
$LANGDATA['L_SM_USERS'] = "Usuarios";
$LANGDATA['L_SM_USERS_DESC'] = "Desde aquí podras administrar los usuarios";
$LANGDATA['L_SM_SEARCH_USER'] = "Buscar Usuario";
$LANGDATA['L_SM_USERS_LIST'] = "Lista de usuarios";
...
$LANGDATA['L_SM_USERS_DISABLE'] = "Usuarios deshabilitados";
...
$LANGDATA['L_SM_E_HTTPS'] = "Lo siento, solo aceptamos enlaces alojadas en servidor seguro (https)";
$LANGDATA['L_SM_E_USER_EXISTS'] = "Usuario ya existe";
$LANGDATA['L_SM_LOG_FB'] = "Identificate con Facebook!";
$LANGDATA['L_SM_REG_FB'] = "Registrate con Facebook!";
$LANGDATA['L_SM_OAUTH_FB_ERROR_1'] = "Graph returned an error: ";
$LANGDATA['L_SM_OAUTH_FB_ERROR_2'] = "Facebook SDK returned an error: ";
$LANGDATA['L_SM_OAUTH_FB_ERROR_3'] = "Error getting long-lived access token: ";
$LANGDATA['L_SM_OAUTH_OAUTH_ERROR'] = "OAuth error: ";
$LANGDATA['L_SM_OAUTH_OAUTH_BADREQUEST'] = "OAuth Bad Request";
$LANGDATA['L_SM_OAUTH_E_ID'] = "OAuth ID desconocido, imposible continuar";
