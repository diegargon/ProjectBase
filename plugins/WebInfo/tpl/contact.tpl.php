            ...
            <div class="contact_form">
                <?php if (defined('RECAPTCHA') && $config['WEBINFO_RECAPTCHA']) { ?>
                    <div id="captcha" class="center">
                        <div class="g-recaptcha" data-callback="rc_cb" data-sitekey="<?= $config['RC_PUBLIC_KEY'] ?>">
                        </div>
                    </div>
                <?php } ?>              
                <div id="submitbtn" class="center">
                    <input disabled id="btnSend" type="submit" tabindex="6" name="submit" value="<?= $LANGDATA['L_SEND'] ?>" />
                </div>
            </div>        
        </form>
    </div>
