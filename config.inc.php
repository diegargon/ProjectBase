...
$config['WEB_URL'] = "https://projectbase.envigo.net/";
$config['STATIC_SRV_URL'] = $config['WEB_URL'];
$config['WEB_LOGO'] = $config['STATIC_SRV_URL'] . "favicon-96x96.png";
$config['WEB_LANG'] = "es";
...
$config['CON_FILE'] = "index.php"; // need change manually in htaccess
...
$config['BAD_BOTS'] = "ia_archiver|Altavista|eStyle|MJ12bot|ips-agent|Yandex|Semrush|Baidu|Sogou|Pcore";
